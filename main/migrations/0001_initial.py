    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(blank=True, default="Student", max_length=100),
                ),
                (
                    "photo",
                    models.ImageField(
                        blank=True,
                        default="profile_pics/default_student.png",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="students", to="main.course"
                    ),
                ),
                (
                    "department",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(blank=True, default="Faculty", max_length=100),
                ),
                (
                    "photo",
                    models.ImageField(
                        blank=True,
                        default="profile_pics/default_faculty.png",
                        upload_to="profile_pics",
                    ),
                ),
                (
